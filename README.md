...
- **Audio Watermarking**: Optional AudioSeal watermarking can be enabled during generation
...
uv run python start.py generate "Hello, this is watermarked." --watermark -o marked.wav
...
KugelAudio supports optional imperceptible watermarking using [Facebook's AudioSeal](https://huggingface.co/facebook/audioseal) technology. Enable watermarking explicitly during generation when you want detection support.
...
Watermarking can be enabled explicitly to support detection of AI-generated content.
